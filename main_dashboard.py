...
with st.sidebar.expander("📖 所有功能連結 (顯示更多)"):
    ...
    st.markdown("---")
    st.markdown("##### 設備資料與管理")
    st.page_link("pages/equipment_system.py", label="設備請購維修系統", icon="📋")
    ...
    st.markdown("---")
    st.markdown("##### 保養履歷")
    st.page_link("pages/maintenance_log.py", label="設備檢修保養履歷", icon="🧾")
    st.page_link("pages/edit_log.py", label="編輯履歷資料", icon="✏️")
    ...
    st.page_link("pages/view_main_equipment.py", label="主設備總覽", icon="🔍")
